...
var _text_vsigned = []byte{
	...
	0x48, 0xc7, 0x42, 0x30, 0x00, 0x00, 0x00, 0x00, //0x0000001f movq         $0, $48(%rdx)
	0x48, 0x8b, 0x0e, //0x00000027 movq         (%rsi), %rcx
	0x48, 0x89, 0x4a, 0x18, //0x0000002a movq         %rcx, $24(%rdx)
	0x4c, 0x39, 0xd8, //0x0000002e cmpq         %r11, %rax
	0x0f, 0x83, 0x45, 0x00, 0x00, 0x00, //0x00000031 jae          LBB0_1
	0x41, 0x8a, 0x0c, 0x01, //0x00000037 movb         (%r9,%rax), %cl
	0x41, 0xb8, 0x01, 0x00, 0x00, 0x00, //0x0000003b movl         $1, %r8d
	0x80, 0xf9, 0x2d, //0x00000041 cmpb         $45, %cl
	0x0f, 0x85, 0x18, 0x00, 0x00, 0x00, //0x00000044 jne          LBB0_5
	0x48, 0x83, 0xc0, 0x01, //0x0000004a addq         $1, %rax
	0x4c, 0x39, 0xd8, //0x0000004e cmpq         %r11, %rax
	0x0f, 0x83, 0x25, 0x00, 0x00, 0x00, //0x00000051 jae          LBB0_1
	0x41, 0x8a, 0x0c, 0x01, //0x00000057 movb         (%r9,%rax), %cl
	0x49, 0xc7, 0xc0, 0xff, 0xff, 0xff, 0xff, //0x0000005b movq         $-1, %r8
	//0x00000062 LBB0_5
	0x8d, 0x79, 0xd0, //0x00000062 leal         $-48(%rcx), %edi
	0x40, 0x80, 0xff, 0x0a, //0x00000065 cmpb         $10, %dil
	0x0f, 0x82, 0x1a, 0x00, 0x00, 0x00, //0x00000069 jb           LBB0_7
	0x48, 0x89, 0x06, //0x0000006f movq         %rax, (%rsi)
	0x48, 0xc7, 0x02, 0xfe, 0xff, 0xff, 0xff, //0x00000072 movq         $-2, (%rdx)
	0x5b, //0x00000079 popq         %rbx
	0x5d, //0x0000007a popq         %rbp
	0xc3, //0x0000007b retq         
	//0x0000007c LBB0_1
	0x4c, 0x89, 0x1e, //0x0000007c movq         %r11, (%rsi)
	0x48, 0xc7, 0x02, 0xff, 0xff, 0xff, 0xff, //0x0000007f movq         $-1, (%rdx)
	0x5b, //0x00000086 popq         %rbx
	0x5d, //0x00000087 popq         %rbp
	0xc3, //0x00000088 retq         
	//0x00000089 LBB0_7
	0x80, 0xf9, 0x30, //0x00000089 cmpb         $48, %cl
	0x0f, 0x85, 0x35, 0x00, 0x00, 0x00, //0x0000008c jne          LBB0_12
	0x48, 0x8d, 0x78, 0x01, //0x00000092 leaq         $1(%rax), %rdi
	0x4c, 0x39, 0xd8, //0x00000096 cmpq         %r11, %rax
	0x0f, 0x83, 0x8a, 0x00, 0x00, 0x00, //0x00000099 jae          LBB0_11
	0x41, 0x8a, 0x0c, 0x39, //0x0000009f movb         (%r9,%rdi), %cl
	0x80, 0xc1, 0xd2, //0x000000a3 addb         $-46, %cl
	0x80, 0xf9, 0x37, //0x000000a6 cmpb         $55, %cl
	0x0f, 0x87, 0x7a, 0x00, 0x00, 0x00, //0x000000a9 ja           LBB0_11
	0x44, 0x0f, 0xb6, 0xd1, //0x000000af movzbl       %cl, %r10d
	0x48, 0xb9, 0x01, 0x00, 0x80, 0x00, 0x00, 0x00, 0x80, 0x00, //0x000000b3 movabsq      $36028797027352577, %rcx
	0x4c, 0x0f, 0xa3, 0xd1, //0x000000bd btq          %r10, %rcx
	0x0f, 0x83, 0x62, 0x00, 0x00, 0x00, //0x000000c1 jae          LBB0_11
	//0x000000c7 LBB0_12
	0x4c, 0x39, 0xd8, //0x000000c7 cmpq         %r11, %rax
	0x4d, 0x89, 0xda, //0x000000ca movq         %r11, %r10
	0x4c, 0x0f, 0x47, 0xd0, //0x000000cd cmovaq       %rax, %r10
	0x31, 0xc9, //0x000000d1 xorl         %ecx, %ecx
