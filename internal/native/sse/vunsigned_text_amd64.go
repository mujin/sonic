...
var _text_vunsigned = []byte{
	...
	0x48, 0xc7, 0x42, 0x30, 0x00, 0x00, 0x00, 0x00, //0x00000022 movq         $0, $48(%rdx)
	0x48, 0x8b, 0x06, //0x0000002a movq         (%rsi), %rax
	0x48, 0x89, 0x42, 0x18, //0x0000002d movq         %rax, $24(%rdx)
	0x4c, 0x39, 0xf1, //0x00000031 cmpq         %r14, %rcx
	0x0f, 0x83, 0x1b, 0x00, 0x00, 0x00, //0x00000034 jae          LBB0_1
	0x41, 0x8a, 0x04, 0x09, //0x0000003a movb         (%r9,%rcx), %al
	0x3c, 0x2d, //0x0000003e cmpb         $45, %al
	0x0f, 0x85, 0x1e, 0x00, 0x00, 0x00, //0x00000040 jne          LBB0_4
	//0x00000046 LBB0_3
	0x48, 0x89, 0x0e, //0x00000046 movq         %rcx, (%rsi)
	0x49, 0xc7, 0x00, 0xfa, 0xff, 0xff, 0xff, //0x00000049 movq         $-6, (%r8)
	0x5b, //0x00000050 popq         %rbx
	0x41, 0x5e, //0x00000051 popq         %r14
	0x5d, //0x00000053 popq         %rbp
	0xc3, //0x00000054 retq         
	//0x00000055 LBB0_1
	0x4c, 0x89, 0x36, //0x00000055 movq         %r14, (%rsi)
	0x49, 0xc7, 0x00, 0xff, 0xff, 0xff, 0xff, //0x00000058 movq         $-1, (%r8)
	0x5b, //0x0000005f popq         %rbx
	0x41, 0x5e, //0x00000060 popq         %r14
	0x5d, //0x00000062 popq         %rbp
	0xc3, //0x00000063 retq         
	//0x00000064 LBB0_4
	0x8d, 0x50, 0xd0, //0x00000064 leal         $-48(%rax), %edx
	0x80, 0xfa, 0x0a, //0x00000067 cmpb         $10, %dl
	0x0f, 0x82, 0x0f, 0x00, 0x00, 0x00, //0x0000006a jb           LBB0_6
	0x48, 0x89, 0x0e, //0x00000070 movq         %rcx, (%rsi)
	0x49, 0xc7, 0x00, 0xfe, 0xff, 0xff, 0xff, //0x00000073 movq         $-2, (%r8)
	0x5b, //0x0000007a popq         %rbx
	0x41, 0x5e, //0x0000007b popq         %r14
	0x5d, //0x0000007d popq         %rbp
	0xc3, //0x0000007e retq         
	//0x0000007f LBB0_6
	0x3c, 0x30, //0x0000007f cmpb         $48, %al
	0x0f, 0x85, 0x26, 0x00, 0x00, 0x00, //0x00000081 jne          LBB0_10
	0x41, 0x8a, 0x44, 0x09, 0x01, //0x00000087 movb         $1(%r9,%rcx), %al
	0x04, 0xd2, //0x0000008c addb         $-46, %al
	0x3c, 0x37, //0x0000008e cmpb         $55, %al
	0x0f, 0x87, 0xbf, 0x00, 0x00, 0x00, //0x00000090 ja           LBB0_9
	0x0f, 0xb6, 0xc0, //0x00000096 movzbl       %al, %eax
	0x48, 0xba, 0x01, 0x00, 0x80, 0x00, 0x00, 0x00, 0x80, 0x00, //0x00000099 movabsq      $36028797027352577, %rdx
	0x48, 0x0f, 0xa3, 0xc2, //0x000000a3 btq          %rax, %rdx
	0x0f, 0x83, 0xa8, 0x00, 0x00, 0x00, //0x000000a7 jae          LBB0_9
	//0x000000ad LBB0_10
	0x49, 0x39, 0xce, //0x000000ad cmpq         %rcx, %r14
	0x49, 0x89, 0xca, //0x000000b0 movq         %rcx, %r10
	0x4d, 0x0f, 0x47, 0xd6, //0x000000b3 cmovaq       %r14, %r10
	0x31, 0xc0, //0x000000b7 xorl         %eax, %eax
	0x41, 0xbb, 0x0a, 0x00, 0x00, 0x00, //0x000000b9 movl         $10, %r11d
	...
	0x0f, 0x84, 0x12, 0xff, 0xff, 0xff, //0x0000012e je           LBB0_3
	0x80, 0xfa, 0x45, //0x00000134 cmpb         $69, %dl
	0x0f, 0x84, 0x09, 0xff, 0xff, 0xff, //0x00000137 je           LBB0_3
	0x80, 0xfa, 0x65, //0x0000013d cmpb         $101, %dl
	0x0f, 0x84, 0x00, 0xff, 0xff, 0xff, //0x00000140 je           LBB0_3
	//0x00000146 LBB0_21
